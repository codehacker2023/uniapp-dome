...
(function(vue) {
  ...
  const _sfc_main$2 = {
    __name: "index",
    setup(__props) {
      const title = "hello 00111";
      vue.onMounted(() => {
        formatAppLog("log", "at pages/index/index.vue:20", "onMounted");
      });
      onLoad(() => {
        formatAppLog("log", "at pages/index/index.vue:24", "onLoad");
      });
      return (_ctx, _cache) => {
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__file", "/Users/yihualiu/Documents/HBuilderProjects/01_hello_world/pages/index/index.vue"]]);
  ...
  const _sfc_main$1 = {
    ...
    onBackPress() {
      ...
      downloadTask$1 && downloadTask$1.abort();
    },
    onHide() {
    ...
    methods: {
      ...
      downloadPackage() {
        ...
        downloadTask$1 = uni.downloadFile({
          url: this.url,
          success: (res) => {
        ...
        downloadTask$1.onProgressUpdate((res) => {
  ...
  const Uni_modulesUniUpgradeCenterAppPagesUpgradePopup = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "/Users/yihualiu/Documents/HBuilderProjects/01_hello_world/uni_modules/uni-upgrade-center-app/pages/upgrade-popup.vue"]]);
  ...
  const b = true, k = "app", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.3.8",\n        "198.18.0.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7001,\n    "skipFiles": [\n        "<node_internals>/**",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"uni-upgrade-center","spaceId":"mp-18dfc33e-876b-4c9b-a64e-fc11aa5c0844","clientSecret":"maMBYY/cjd7C+CYDb2oWkQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
  let x = "";
  try {
    x = "__UNI__7DC69DA";
  } catch (e) {
...
详细信息：${s4}`), r3(i3);
  ...
  function checkUpdate() {
    return new Promise((resolve, reject) => {
      callCheckVersion().then(async (e) => {
        ...
        formatAppLog("error", "at uni_modules/uni-upgrade-center-app/utils/check-update.js:77", err2.message);
        reject(err2);
      });
    });
  }
        ...
        downloadTask = uni.downloadFile({
          ...
          success: (res2) => {
            if (res2.statusCode !== 200) {
              formatAppLog("error", "at uni_modules/uni-upgrade-center-app/utils/check-update.js:125", "下载安装包失败", err);
              return;
            }
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/yihualiu/Documents/HBuilderProjects/01_hello_world/App.vue"]]);
  function createApp() {
